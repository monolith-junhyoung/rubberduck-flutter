...
import 'package:rubberduck_flutter/app/launch/launch_bootstrap_page.dart';
...
void main() {
  testWidgets('shows waiting screen when launched without valid link', (tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: const LaunchBootstrapPage(
...
Widget _resolvedTestBuilder(RuntimeControllerConfig config) {
