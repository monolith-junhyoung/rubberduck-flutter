...
class DuckPilotViewState {
  const DuckPilotViewState({
  ...
  factory DuckPilotViewState.initial() {
    return const DuckPilotViewState(
      playerName: '',
